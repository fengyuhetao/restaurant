      ...
      <tbody>
       <?php 
        ...
        <tr>
          ...
          <td><?php echo $row['dealMoney'];?></td>
          <td><?php echo mb_strlen($row['eventDescription'])>25?mb_substr($row['eventDescription'],0,25,"utf-8")."...":$row['eventDescription'];?></td>
          <td><?php echo $row['staffID'];?></td>
          <td>
          	  <a href="show_repairinfo.php?id=<?php echo $row['repairID'];?>"><i class="icon-list"></i></a>
              <a href="modify_repairinfo.php?id=<?php echo $row['repairID'];?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal"><i id="<?php echo $row['repairID'];?>" onClick="PassID(this)" class="icon-remove"></i></a>
          </td>
        </tr>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script>
		function GoToTianJia(){
			window.location.href="add_repairinfo.php";
		}
		var staffid;
		function PassID(obj){
			repairid=obj.id;
		...
		function Del(){
			//alert(staffid);
			window.location.href="repairinfo.php?id="+repairid;
		}
	</script>
  </body>
</html>
