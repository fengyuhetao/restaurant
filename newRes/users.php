...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <a href="#dasd-menu" class="nav-header" data-toggle="collapse"><i class="icon-dashboard"></i>Dashboard</a>
        <ul id="dasd-menu" class="nav nav-list collapse in">
            <li><a href="index.php">Home</a></li>
            <li class="active"><a href="users.php">Sample List</a></li>
         ...
         <a href="#asd-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>财务管理<span class="label label-info">+2</span></a>
        <ul id="asd-menu" class="nav nav-list collapse in">
