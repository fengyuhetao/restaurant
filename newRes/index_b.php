<?php require_once('Connections/webLocal.php'); ?>
<?php
...
if (isset($_POST['uname'])) {
  ...
  mysql_select_db($database_webLocal, $webLocal);
  
  $LoginRS__query=sprintf("SELECT userName, password FROM usersystem WHERE userName=%s AND password=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $webLocal) or die(mysql_error());
        ...
        <div class="block">
            ...
            <div class="block-body">
                <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="form1" name="form1">
                    <label>用户名</label>
                    <input type="text" class="span12" name="uname" id="uname" placeholder="用户ID号" />
                    <label>密码</label>
                    <input type="password" class="span12" name="upass" id="upass" placeholder="*********"/>
                    <input type="submit" class="btn btn-primary pull-right" value="登录">
                        <div class="alert">
 <strong>Warning!</strong> Best check your name and password.
    </div>
