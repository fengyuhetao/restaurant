...
<input type="radio" name="Time" onChange="changeSrc('sell_day.php')"/>过去一周内&nbsp;
<input type="radio" name="Time" checked onChange="changeSrc('sell_day.php')"/>过去一月内&nbsp;
<input type="radio" name="Time" onChange="changeSrc('sell_day.php')"/>过去一个季度中&nbsp;   
<input type="radio" name="Time" onChange="changeSrc('sell_day.php')"/>过去一年内&nbsp;
<hr>
