...
-- Records of bill
-- ----------------------------
INSERT INTO `bill` VALUES ('1', '1', '200.00', '2015-05-25', '1');
...
-- Records of food
-- ----------------------------
INSERT INTO `food` VALUES ('1', '酸辣土豆丝', '10.00', '川菜', '辣');
INSERT INTO `food` VALUES ('2', '干辣椒', '11.00', '川菜', '辣');
INSERT INTO `food` VALUES ('3', '炒青菜', '2.00', '川菜', '不辣');
INSERT INTO `food` VALUES ('4', '酸辣鲤鱼', '18.00', '川菜', '微辣');
INSERT INTO `food` VALUES ('5', '酸辣鲫鱼', '17.00', '川菜', '微辣');
INSERT INTO `food` VALUES ('6', '酸辣草鱼', '15.00', ' 川菜', '微辣');
...
-- Records of seat
-- ----------------------------
INSERT INTO `seat` VALUES ('1', '1', '0', '一楼');
INSERT INTO `seat` VALUES ('2', '2', '0', '一楼');
INSERT INTO `seat` VALUES ('3', '3', '0', '一楼');
INSERT INTO `seat` VALUES ('4', '4', '0', '二楼');
INSERT INTO `seat` VALUES ('5', '5', '0', '二楼');
INSERT INTO `seat` VALUES ('6', '6', '0', '二楼');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`web`@`localhost` SQL SECURITY DEFINER VIEW `tadaymenu` AS select `food`.`foodName` AS `foodName`,`food`.`price` AS `price`,`food`.`foodType` AS `foodType`,`food`.`description` AS `description`,`menu`.`state` AS `state` from (`menu` join `food`) where (`menu`.`foodID` = `food`.`foodID`) ;
